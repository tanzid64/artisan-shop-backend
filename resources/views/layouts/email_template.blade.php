        ...
        <tr>
            <td align="center" valign="top" bgcolor="#24140e" style="background-color:#fff;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="container"
                    style="width:100%;border: solid 1px #d6d4d4;">
                    <tr>
                    ...
                    <tr style="background-color: #fff;">
                        <td class="container-padding footer-text" align="left"
                            ...
                            <br>
                            <span class="ios-footer" style=" text-align:center;display: block;"> © Copyright
                                {{ date('Y') }} {{ config('app.name') }} - All Rights Reserved </span> <br>
                            <br>
                        </td>
                    </tr>
                </table>
